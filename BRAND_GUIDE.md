...
- Structure:
  - circular badge
  - black shell as the base
  - red field for bear-side tension
  - simplified bull/bear silhouette confrontation
  - green bullish accent as a small positive slash
- Intent:
  - read as market confrontation first
  - feel strong at favicon and app-icon size
  - avoid candles, bars, or overly literal chart motifs
- Usage:
  - browser tab / app icon
  - left side of the main app header
  - symbol-only compact placements
...
## Responsive Rules
- Desktop:
  - keep the left symbol visible
  - keep the wordmark pinned to the true center of the header
- Mobile / narrow widths:
  - wordmark takes priority
  - left symbol may collapse or hide
  - no overlap, wrapping, or drift
