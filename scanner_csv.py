...
SCANNER_CSV_FIELD_SPECS: tuple[dict[str, str], ...] = (
    ...
    {"group": "판단V2", "key": "direction_judgment", "label": "DirectionJudgment", "type": "text", "description": "Directional bias separated from entry timing", "rule": "Trade_Judgment mapped to BUY/SELL/NEUTRAL", "example": "BUY"},
    {"group": "판단V2", "key": "entry_judgment", "label": "EntryJudgment", "type": "text", "description": "Entry timing judgment", "rule": "ENTER_NOW / WAIT_PULLBACK / WAIT_BREAKOUT_CONFIRM / CHASE_RISK / NO_TRADE / EXIT_OR_AVOID", "example": "WAIT_PULLBACK"},
    {"group": "판단V2", "key": "risk_judgment", "label": "RiskJudgment", "type": "text", "description": "Entry risk bucket", "rule": "LOW / MEDIUM / HIGH", "example": "MEDIUM"},
    {"group": "판단V2", "key": "position_action", "label": "PositionAction", "type": "text", "description": "Action guidance derived from entry judgment", "rule": "BUY_NOW / WATCHLIST / WAIT / AVOID / SELL_OR_EXIT", "example": "WATCHLIST"},
    {"group": "판단V2", "key": "final_entry_score_v2", "label": "FinalEntryScoreV2", "type": "number", "description": "Additive entry score v2; not used by QBS in Phase 1", "rule": "trend/timing/flow/RR minus risk penalty", "example": "76.5"},
    {"group": "판단V2", "key": "trend_quality_score", "label": "TrendQualityScore", "type": "number", "description": "Trend quality component for entry decision v2", "rule": "trend, HMA/EMA, ADX, conflict quality", "example": "68.0"},
    {"group": "판단V2", "key": "entry_timing_score", "label": "EntryTimingScore", "type": "number", "description": "Entry timing component for entry decision v2", "rule": "turns, pullback, HMA/EMA entry, final-entry readiness", "example": "54.0"},
    {"group": "판단V2", "key": "volume_flow_score", "label": "VolumeFlowScore", "type": "number", "description": "Volume and flow component for entry decision v2", "rule": "volume ratio, CMF, OBV slope", "example": "72.0"},
    {"group": "판단V2", "key": "risk_penalty_score", "label": "RiskPenaltyScore", "type": "number", "description": "Risk penalty component for entry decision v2", "rule": "hard risk, conflict, chase risk", "example": "12.0"},
    {"group": "판단V2", "key": "rr_score", "label": "RRScore", "type": "number", "description": "Risk/reward component for entry decision v2", "rule": "normalized RR", "example": "65.0"},
    {"group": "판단V2", "key": "entry_chase_risk", "label": "EntryChaseRisk", "type": "bool", "description": "Engine-level chase-risk flag for entry timing", "rule": "short-term extension / overheat checks", "example": "Y"},
    {"group": "판단V2", "key": "final_adjusted_score", "label": "FinalAdjustedScore", "type": "number", "description": "Additive adjusted score; existing Final_Decision_Score is preserved", "rule": "risk and conflict adjustments after entry decision", "example": "42.0"},
    {"group": "판단V2", "key": "final_adjusted_confidence", "label": "FinalAdjustedConfidence", "type": "number", "description": "Additive adjusted confidence; existing Judgment_Confidence is preserved", "rule": "risk and conflict confidence adjustments", "example": "64.0"},
    {"group": "판단V2", "key": "final_adjustment_reasons", "label": "FinalAdjustmentReasons", "type": "text", "description": "Compact reasons for adjusted score/confidence", "rule": "reason tokens joined with +", "example": "entry_chase_risk+hard_risk"},
    {"group": "TradePlan", "key": "entry_zone_low", "label": "EntryZoneLow", "type": "number", "description": "Lower bound of preferred entry zone", "rule": "nearest support based plan level when available", "example": "38.20"},
    {"group": "TradePlan", "key": "entry_zone_high", "label": "EntryZoneHigh", "type": "number", "description": "Upper bound of preferred entry zone", "rule": "nearest support based plan level when available", "example": "38.80"},
    {"group": "TradePlan", "key": "invalidation_level", "label": "InvalidationLevel", "type": "number", "description": "Level that invalidates the setup", "rule": "support minus buffer when available", "example": "37.40"},
    {"group": "TradePlan", "key": "nearest_support", "label": "NearestSupport", "type": "number", "description": "Nearest support level below current price", "rule": "MA/EMA/VP/Fib/channel support candidates", "example": "38.20"},
    {"group": "TradePlan", "key": "nearest_resistance", "label": "NearestResistance", "type": "number", "description": "Nearest resistance level above current price", "rule": "BB/VP/Fib/channel resistance candidates", "example": "41.50"},
    {"group": "TradePlan", "key": "target_1", "label": "Target1", "type": "number", "description": "First target level", "rule": "nearest resistance or 1.5R fallback", "example": "41.50"},
    {"group": "TradePlan", "key": "target_2", "label": "Target2", "type": "number", "description": "Second target level", "rule": "2R fallback when available", "example": "44.00"},
    {"group": "TradePlan", "key": "rr", "label": "RR", "type": "number", "description": "Risk/reward ratio", "rule": "existing RR or computed target/risk", "example": "1.80"},
    {"group": "TradePlan", "key": "entry_reason", "label": "EntryReason", "type": "text", "description": "Compact entry decision reason", "rule": "top v2 decision reasons", "example": "HMA/EMA long entry + volume 1.40x"},
    {"group": "TradePlan", "key": "risk_notes", "label": "RiskNotes", "type": "text", "description": "Compact risk notes", "rule": "risk tokens joined with +", "example": "entry_chase_risk"},
